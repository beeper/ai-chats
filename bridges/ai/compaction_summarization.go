...
const (
	...
	compactionIdentifierPreservationInstructions = "Preserve all opaque identifiers exactly as written (no shortening or reconstruction), including UUIDs, hashes, IDs, hostnames, IPs, ports, URLs, and file names. Do NOT preserve secrets, API keys, or authentication tokens—replace them with [REDACTED]."
