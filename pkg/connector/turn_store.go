...
func normalizeAITurnMetadata(meta *MessageMetadata, turnData aihelpers.TurnData) *MessageMetadata {
	...
	if clean.Body == "" {
		clean.Body = aihelpers.TurnText(turnData)
	}
	return clean
}
...
func decodeAITurnMetadata(raw string, turnData aihelpers.TurnData) (*MessageMetadata, error) {
