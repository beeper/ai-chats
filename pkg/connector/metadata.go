...
type MessageMetadata struct {
	...
	aihelpers.AssistantMessageMetadata
...
type GeneratedFileRef = aihelpers.GeneratedFileRef

type ToolCallMetadata = aihelpers.ToolCallMetadata
...
func (mm *MessageMetadata) CopyFrom(other any) {
	...
	aihelpers.CopyFromBaseAndAssistant(&mm.BaseMessageMetadata, &src.BaseMessageMetadata, &mm.AssistantMessageMetadata, &src.AssistantMessageMetadata)
}
