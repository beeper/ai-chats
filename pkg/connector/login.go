...
// Provider constants - all use OpenAI AIHelper with different base URLs
const (
...
var (
	...
	errAIReloginTargetInvalid = aihelpers.NewLoginRespError(http.StatusBadRequest, "Invalid relogin target.", "AI", "INVALID_RELOGIN_TARGET")
	errAIMissingUserContext   = aihelpers.NewLoginRespError(http.StatusInternalServerError, "Missing user context for login.", "AI", "MISSING_USER_CONTEXT")
	errAIMissingReloginMeta   = aihelpers.NewLoginRespError(http.StatusInternalServerError, "Missing relogin metadata.", "AI", "MISSING_RELOGIN_METADATA")
)
