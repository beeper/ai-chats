...
func TestDecideQueuePolicy_InterruptWithActiveRun(t *testing.T) {
	...
	decision := airuntime.DecideQueueAction(airuntime.QueueMode(QueueModeInterrupt), client.roomHasActiveRun("!room:test"), false)
...
func TestDecideQueuePolicy_BacklogWithoutActiveRun(t *testing.T) {
	...
	decision := airuntime.DecideQueueAction(airuntime.QueueMode(QueueModeCollect), client.roomHasActiveRun("!room:test"), false)
