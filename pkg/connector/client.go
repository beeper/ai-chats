...
func newAIClient(login *bridgev2.UserLogin, connector *OpenAIConnector, apiKey string, cfg *aiLoginConfig) (*AIClient, error) {
	...
	// All providers use the OpenAI AIHelper with different base URLs.
...
func (oc *AIClient) GetApprovalHandler() aihelpers.ApprovalReactionHandler {
	return nil
}
