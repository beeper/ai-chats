...
// TurnData is the AI helper-owned semantic turn record used as the canonical source
...
// primarily used by the AI helper turn runtime, where the canonical turn record is
...
// UIMessageFromTurnData projects canonical turn data into an AI AI helper UIMessage
