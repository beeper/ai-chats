...
var _ bridgev2.NetworkAPI = (*aiHelperClient[any, any])(nil)

// pendingAIHelperApprovalData holds AI helper-specific metadata for a pending tool approval.
...
type aiHelperClient[SessionT SessionValue, ConfigDataT ConfigValue] struct {
	ClientBase
	cfg               *Config[SessionT, ConfigDataT]
	userLogin         *bridgev2.UserLogin
	approvalFlow      *ApprovalFlow[*pendingAIHelperApprovalData]
...
func newAIHelperClient[SessionT SessionValue, ConfigDataT ConfigValue](login *bridgev2.UserLogin, cfg *Config[SessionT, ConfigDataT]) *aiHelperClient[SessionT, ConfigDataT] {
...
func (c *aiHelperClient[SessionT, ConfigDataT]) GetApprovalHandler() ApprovalReactionHandler {
	return c.approvalFlow
}

// Connect implements bridgev2.NetworkAPI.
func (c *aiHelperClient[SessionT, ConfigDataT]) Connect(ctx context.Context) {
...
func (c *aiHelperClient[SessionT, ConfigDataT]) Disconnect() {
	c.SetLoggedIn(false)
...
func (c *aiHelperClient[SessionT, ConfigDataT]) LogoutRemote(ctx context.Context) {
	c.Disconnect()
}

func (c *aiHelperClient[SessionT, ConfigDataT]) IsThisUser(_ context.Context, userID networkid.UserID) bool {
...
func (c *aiHelperClient[SessionT, ConfigDataT]) GetChatInfo(ctx context.Context, portal *bridgev2.Portal) (*bridgev2.ChatInfo, error) {
...
func (c *aiHelperClient[SessionT, ConfigDataT]) GetUserInfo(_ context.Context, ghost *bridgev2.Ghost) (*bridgev2.UserInfo, error) {
...
func (c *aiHelperClient[SessionT, ConfigDataT]) GetCapabilities(ctx context.Context, portal *bridgev2.Portal) *event.RoomFeatures {
	c.sessionMu.RLock()
	session := c.session
	c.sessionMu.RUnlock()
...
func (c *aiHelperClient[SessionT, ConfigDataT]) HandleMatrixMessage(ctx context.Context, msg *bridgev2.MatrixMessage) (*bridgev2.MatrixMessageResponse, error) {
	...
	go func() {
		...
		c.userLogin.Log.Error().
			...
			Msg("AI helper matrix message handler failed")
